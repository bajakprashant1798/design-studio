      ...
      {collections.length === 0 ? (
        <div className="py-16 text-center space-y-6 max-w-sm mx-auto">
          <p className="text-xs text-zinc-500 font-light leading-relaxed">
            We are currently refining our seasonal lookbooks. In the meantime, explore our
            functional categories for high-quality everyday essentials.
          </p>
          <Link
            href="/categories"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {collections.map((col) => (
            <Link
              ...
              className="group relative block aspect-[3/2] overflow-hidden bg-zinc-100"
            >
